...
class DefaultController extends Controller {
    ...
    public function categoriaAction( $id_categoria ){
        ...
        $producto = $em->getRepository('AppTiendaOnlineBundle:Producto')->findAll();
        $categorias = $em->getRepository('AppTiendaOnlineBundle:Categoria')->findAll();
        $categoria = $em->getRepository('AppTiendaOnlineBundle:Categoria')->find( $id_categoria );
        
   
        return $this->render('AppSiteBundle:Pages:ver.categoria.html.twig' , array("producto" => $producto, "categorias" => $categorias , "categoria" => $categoria  ));
    }
    ...
    public function generar_slugAction() {
        ...
        $em = $this->getDoctrine()->getManager();
        $productos = $em->getRepository('AppTiendaOnlineBundle:Producto')->findAll();
        ...
        foreach ($productos as $producto) {
            ...
            $em->flush();
            echo "producto id:" . $producto->getId() . " slug:" . $producto->getSlug();
            echo "<br>";
        }
        die();
